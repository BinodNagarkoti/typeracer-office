...
const Hyperspeed = ({ effectOptions = {} }: { effectOptions?: Record<string, any> }) => {
  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      init() {
        ...
        if (Array.isArray(colorsArr)) {
          colorsArr = colorsArr.map((c) => new THREE.Color(c));
        } else {
          colorsArr = new THREE.Color(colorsArr);
        }
        ...
        for (let i = 0; i < options.lightPairsPerRoadWay; i++) {
          ...
          const color = pickRandom(colorsArr);
    ...
    class Road {
      ...
      createPlane(side: any, width: any, isRoad: any) {
        const options = this.options;
        const segments = 100;
    ...
    mergedOptions.distortion = (distortions as any)[mergedOptions.distortion];
